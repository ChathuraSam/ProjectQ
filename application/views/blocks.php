    ...
    <div class="row mt-5 align-items-top">
      <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left">
        <div class="bg-gray p-3 text-center rounded sl-1">
          ...
          <img src="<?php echo base_url(); ?>/img/main-page/basic-model.jpg" width='200px' height='200px'>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-md-0">
        <div class="bg-gray p-3 text-center rounded sl-1">
          ...
          <img src="<?php echo base_url(); ?>/img/main-page/model-bike.jpg" width='200px' height='200px'>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-xl-0">
        <div class="bg-gray p-3 text-center rounded sl-1">
          ...
          <img src="<?php echo base_url(); ?>/img/main-page/model-heart.png" width='200px' height='200px'>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-10 col-md-6 col-lg-5 m-auto col-xl-3 text-left pt-5 pt-xl-0">
        <div class="bg-gray p-3 text-center rounded sl-1">
          ...
          <img src="<?php echo base_url(); ?>/img/main-page/model-thanos.jpg" width='200px' height='200px'>
        </div>
      </div>
    </div>
  </div>
